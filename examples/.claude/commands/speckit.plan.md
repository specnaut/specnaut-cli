...
2. **Load context**: Read FEATURE_SPEC and `.specify/memory/constitution.md`.
   Read `.claude/skills/adonisjs-v7/SKILL.md` (for backend considerations) and `.claude/skills/react/SKILL.md` (for frontend considerations).
...
4. **Stop and report**: Command ends after Phase 2 planning. Report branch,
   IMPL_PLAN path, and generated artifacts. **Always suggest the next command
   inside a fenced code block** for easy copy:
