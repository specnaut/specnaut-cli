...
`__SPECKIT_COMMAND_TASKS__` has successfully produced a complete `tasks.md`.
...
constitution update outside `__SPECKIT_COMMAND_ANALYZE__`.

## Execution Steps

### 1. Initialize Analysis Context

Run `{SCRIPT}` once from repo root and parse JSON for FEATURE_DIR and AVAILABLE_DOCS. Derive
absolute paths:
...
- Provide explicit command suggestions: e.g., "Run **SPECKIT_COMMAND_SPECIFY** with refinement",
  "Run **SPECKIT_COMMAND_PLAN** to adjust architecture", "Manually edit tasks.md to add coverage for
  'performance-metrics'"
