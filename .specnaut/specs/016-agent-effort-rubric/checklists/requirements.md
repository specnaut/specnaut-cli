...
Mechanical frontmatter feature (Size S). Model pins verified: xhigh set
(developer/qa-tester/devops-sre) is Opus-pinned → valid. architect/product-manager not in CLI
bundle. No open markers.
