...
No runtime store. The model is the agent→tier assignment + the model-compat invariant. Asserted by a
test.
...
- medium: a11y-auditor, architecture-auditor, dependency-auditor, performance-auditor,
  security-auditor, code-reviewer, test-reviewer, specflow-expert, product-owner
- high: ui-ux-designer
