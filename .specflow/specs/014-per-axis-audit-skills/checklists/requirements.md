# Specification Quality Checklist: Per-axis scope-targeted audit-dispatch skills
...
## Notes
Depends on #378 (merged). Sibling of #379 (merged). Markdown-only skills (mirrored to plugin/). No
